...
class DirectoryMonitor():
    def __init__(
        ...
        add_existing_files=True, monitor_new=True, max_file_queue_size=3,
        num_processing_threads=1, processing_niceness=10, max_metadata_queue_size=5, max_s3_queue_size=5, num_s3_threads=1,
    ):
